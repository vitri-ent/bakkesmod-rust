...
pub trait GameEvent: Actor {
	fn get_car_archetype(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(GameEvent_TA_Get_CarArchetype(self.addr())) }
	}
	fn get_countdown_time(&self) -> i32 {
		unsafe { GameEvent_TA_Get_CountdownTime(self.addr()) }
	}
	fn get_finish_time(&self) -> i32 {
		unsafe { GameEvent_TA_Get_FinishTime(self.addr()) }
	}
	fn get_b_multiplayer(&self) -> bool {
		unsafe { GameEvent_TA_Get_bMultiplayer(self.addr()) }
	}
	fn get_b_countdown_messages_disabled(&self) -> bool {
		unsafe { GameEvent_TA_Get_bCountdownMessagesDisabled(self.addr()) }
	}
	fn get_b_fill_with_ai(&self) -> bool {
		unsafe { GameEvent_TA_Get_bFillWithAI(self.addr()) }
	}
	fn get_b_allow_queue_save_replay(&self) -> bool {
		unsafe { GameEvent_TA_Get_bAllowQueueSaveReplay(self.addr()) }
	}
	fn get_b_allow_ready_up(&self) -> bool {
		unsafe { GameEvent_TA_Get_bAllowReadyUp(self.addr()) }
	}
	fn get_b_restarting_match(&self) -> bool {
		unsafe { GameEvent_TA_Get_bRestartingMatch(self.addr()) }
	}
	fn get_b_randomized_bot_loadouts(&self) -> bool {
		unsafe { GameEvent_TA_Get_bRandomizedBotLoadouts(self.addr()) }
	}
	fn get_b_has_leave_match_penalty(&self) -> bool {
		unsafe { GameEvent_TA_Get_bHasLeaveMatchPenalty(self.addr()) }
	}
	fn get_b_can_vote_to_forfeit(&self) -> bool {
		unsafe { GameEvent_TA_Get_bCanVoteToForfeit(self.addr()) }
	}
	fn get_b_disable_aim_assist(&self) -> bool {
		unsafe { GameEvent_TA_Get_bDisableAimAssist(self.addr()) }
	}
	fn get_b_award_achievements(&self) -> bool {
		unsafe { GameEvent_TA_Get_bAwardAchievements(self.addr()) }
	}
	fn get_min_players(&self) -> i32 {
		unsafe { GameEvent_TA_Get_MinPlayers(self.addr()) }
	}
	fn get_max_players(&self) -> i32 {
		unsafe { GameEvent_TA_Get_MaxPlayers(self.addr()) }
	}
	...
	fn get_bot_skill(&self) -> f32 {
		unsafe { GameEvent_TA_Get_BotSkill(self.addr()) }
	}
	fn get_match_time_dilation(&self) -> f32 {
		unsafe { GameEvent_TA_Get_MatchTimeDilation(self.addr()) }
	}
	fn get_activator(&self) -> Option<PlayerControllerWrapper> {
		unsafe { PlayerControllerWrapper::try_new(GameEvent_TA_Get_Activator(self.addr())) }
	}
	fn get_activator_car(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(GameEvent_TA_Get_ActivatorCar(self.addr())) }
	}
	...
	fn get_start_point_index(&self) -> i32 {
		unsafe { GameEvent_TA_Get_StartPointIndex(self.addr()) }
	}
	fn get_replicated_state_index(&self) -> u8 {
		unsafe { GameEvent_TA_Get_ReplicatedStateIndex(self.addr()) }
	}
	fn get_game_state_time_remaining(&self) -> i32 {
		unsafe { GameEvent_TA_Get_GameStateTimeRemaining(self.addr()) }
	}
	fn get_replicated_game_state_time_remaining(&self) -> i32 {
		unsafe { GameEvent_TA_Get_ReplicatedGameStateTimeRemaining(self.addr()) }
	}
	...
	fn get_game_owner(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(GameEvent_TA_Get_GameOwner(self.addr())) }
	}
	...
	fn get_replicated_round_count_down_number(&self) -> i32 {
		unsafe { GameEvent_TA_Get_ReplicatedRoundCountDownNumber(self.addr()) }
	}
	...
	fn suppress_modal_dialogs(&self) -> bool {
		unsafe { GameEvent_TA_SuppressModalDialogs(self.addr()) }
	}
	fn should_show_ball_indicator(&self) -> bool {
		unsafe { GameEvent_TA_ShouldShowBallIndicator(self.addr()) }
	}
	...
	fn allow_split_screen_player(&self) -> bool {
		unsafe { GameEvent_TA_AllowSplitScreenPlayer(self.addr()) }
	}
	...
	fn is_playing_training(&self) -> bool {
		unsafe { GameEvent_TA_IsPlayingTraining(self.addr()) }
	}
	fn is_playing_lan(&self) -> bool {
		unsafe { GameEvent_TA_IsPlayingLan(self.addr()) }
	}
	fn is_playing_offline(&self) -> bool {
		unsafe { GameEvent_TA_IsPlayingOffline(self.addr()) }
	}
	fn is_playing_private(&self) -> bool {
		unsafe { GameEvent_TA_IsPlayingPrivate(self.addr()) }
	}
	fn is_playing_public(&self) -> bool {
		unsafe { GameEvent_TA_IsPlayingPublic(self.addr()) }
	}
	fn is_online_multiplayer(&self) -> bool {
		unsafe { GameEvent_TA_IsOnlineMultiplayer(self.addr()) }
	}
	...
	fn all_players_selected_team(&self) -> bool {
		unsafe { GameEvent_TA_AllPlayersSelectedTeam(self.addr()) }
	}
	fn can_que_save_replay(&self) -> bool {
		unsafe { GameEvent_TA_CanQueSaveReplay(self.addr()) }
	}
	...
	fn can_use_ball_cam(&self) -> bool {
		unsafe { GameEvent_TA_CanUseBallCam(self.addr()) }
	}
	fn handle_next_game(&self) -> bool {
		unsafe { GameEvent_TA_HandleNextGame(self.addr()) }
	}
	...
	fn should_be_full_screen(&self) -> bool {
		unsafe { GameEvent_TA_ShouldBeFullScreen(self.addr()) }
	}
	fn is_finished(&self) -> bool {
		unsafe { GameEvent_TA_IsFinished(self.addr()) }
	}
	...
	fn should_auto_ready_up(&self, pri: PriWrapper) -> bool {
		unsafe { GameEvent_TA_ShouldAutoReadyUp(self.addr(), pri.addr()) }
	}
	...
	fn allow_shutdown(&self) -> bool {
		unsafe { GameEvent_TA_AllowShutdown(self.addr()) }
	}
	fn get_real_delta_time(&self, elapsed_time: f32) -> f32 {
		unsafe { GameEvent_TA_GetRealDeltaTime(self.addr(), elapsed_time) }
	}
	...
	fn get_local_primary_player(&self) -> Option<PlayerControllerWrapper> {
		unsafe { PlayerControllerWrapper::try_new(GameEvent_TA_GetLocalPrimaryPlayer(self.addr())) }
	}
	...
	fn move_to_ground(&self, mover: ActorWrapper, height_check: f32) -> bool {
		unsafe { GameEvent_TA_MoveToGround(self.addr(), mover.addr(), height_check) }
	}
	...
	fn get_max_humans(&self) -> i32 {
		unsafe { GameEvent_TA_GetMaxHumans(self.addr()) }
	}
	fn get_num_humans(&self) -> i32 {
		unsafe { GameEvent_TA_GetNumHumans(self.addr()) }
	}
	fn find_bot_replacement(&self, pri: PriWrapper) -> bool {
		unsafe { GameEvent_TA_FindBotReplacement(self.addr(), pri.addr()) }
	}
	...
	fn should_allow_vote_to_forfeit(&self) -> bool {
		unsafe { GameEvent_TA_ShouldAllowVoteToForfeit(self.addr()) }
	}
	...
	fn get_playlist(&self) -> Option<GameSettingPlaylistWrapper> {
		unsafe { GameSettingPlaylistWrapper::try_new(GameEvent_TA_GetPlaylist(self.addr())) }
	}
	fn should_have_leave_match_penalty(&self) -> bool {
		unsafe { GameEvent_TA_ShouldHaveLeaveMatchPenalty(self.addr()) }
	}
