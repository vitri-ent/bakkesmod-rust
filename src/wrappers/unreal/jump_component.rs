...
pub trait JumpComponent: CarComponent {
	fn get_min_jump_time(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_MinJumpTime(self.addr()) }
	}
	fn get_jump_impulse(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_JumpImpulse(self.addr()) }
	}
	fn get_jump_force(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_JumpForce(self.addr()) }
	}
	fn get_jump_force_time(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_JumpForceTime(self.addr()) }
	}
	fn get_podium_jump_force_time(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_PodiumJumpForceTime(self.addr()) }
	}
	fn get_jump_impulse_speed(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_JumpImpulseSpeed(self.addr()) }
	}
	fn get_jump_accel(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_JumpAccel(self.addr()) }
	}
	fn get_max_jump_height(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_MaxJumpHeight(self.addr()) }
	}
	fn get_max_jump_height_time(&self) -> f32 {
		unsafe { CarComponent_Jump_TA_Get_MaxJumpHeightTime(self.addr()) }
	}
	fn get_b_deactivate(&self) -> bool {
		unsafe { CarComponent_Jump_TA_Get_bDeactivate(self.addr()) }
	}
