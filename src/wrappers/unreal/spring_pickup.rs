...
pub trait SpringPickup: TargetedPickup {
	fn get_force(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_Force(self.addr()) }
	}
	fn get_vertical_force(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_VerticalForce(self.addr()) }
	}
	...
	fn get_b_apply_relative_force(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bApplyRelativeForce(self.addr()) }
	}
	fn get_b_apply_constant_force(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bApplyConstantForce(self.addr()) }
	}
	fn get_b_break_constant_force_with_hit(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bBreakConstantForceWithHit(self.addr()) }
	}
	fn get_b_apply_relative_constant_force(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bApplyRelativeConstantForce(self.addr()) }
	}
	fn get_b_instant(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bInstant(self.addr()) }
	}
	fn get_b_follow_after_hit(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bFollowAfterHit(self.addr()) }
	}
	fn get_b_springed(&self) -> bool {
		unsafe { SpecialPickup_Spring_TA_Get_bSpringed(self.addr()) }
	}
	fn get_relative_force_normal_direction(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_RelativeForceNormalDirection(self.addr()) }
	}
	fn get_max_spring_length(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_MaxSpringLength(self.addr()) }
	}
	fn get_constant_force(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_ConstantForce(self.addr()) }
	}
	...
	fn get_spring_mesh_initial_size(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_SpringMeshInitialSize(self.addr()) }
	}
	...
	fn get_hit_distance_offset(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_HitDistanceOffset(self.addr()) }
	}
	fn get_after_spring_duration(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_AfterSpringDuration(self.addr()) }
	}
	fn get_ball_hit_type(&self) -> u8 {
		unsafe { SpecialPickup_Spring_TA_Get_BallHitType(self.addr()) }
	}
	fn get_min_spring_length(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_MinSpringLength(self.addr()) }
	}
	fn get_welded_force_scalar(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_WeldedForceScalar(self.addr()) }
	}
	fn get_welded_vertical_force(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_WeldedVerticalForce(self.addr()) }
	}
	fn get_current_spring_length(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_CurrentSpringLength(self.addr()) }
	}
	fn get_springed_time(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_SpringedTime(self.addr()) }
	}
	fn get_after_spring_time(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_AfterSpringTime(self.addr()) }
	}
	fn get_spring_to_time(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_SpringToTime(self.addr()) }
	}
	...
	fn get_springed_length(&self) -> f32 {
		unsafe { SpecialPickup_Spring_TA_Get_SpringedLength(self.addr()) }
	}
	fn pickup_end(&self) {
		unsafe {
