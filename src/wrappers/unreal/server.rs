...
pub trait Server: TeamGameEvent {
	...
	fn set_game_speed(&self, game_speed: f32) {
		unsafe {
			Server_SetGameSpeed(self.addr(), game_speed);
		}
	}
	...
	fn set_seconds_elapsed(&self, seconds_elapsed: f32) {
		unsafe {
			Server_SetSecondsElapsed(self.addr(), seconds_elapsed);
		}
	}
	...
	fn get_test_car_archetype(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(GameEvent_Soccar_TA_Get_TestCarArchetype(self.addr())) }
	}
	fn get_ball_archetype(&self) -> Option<BallWrapper> {
		unsafe { BallWrapper::try_new(GameEvent_Soccar_TA_Get_BallArchetype(self.addr())) }
	}
	fn get_ball_spawn_point(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(GameEvent_Soccar_TA_Get_BallSpawnPoint(self.addr())) }
	}
	fn get_series_length(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_SeriesLength(self.addr()) }
	}
	fn get_game_time(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_GameTime(self.addr()) }
	}
	fn get_warmup_time(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_WarmupTime(self.addr()) }
	}
	fn get_max_score(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_MaxScore(self.addr()) }
	}
	fn get_auto_balance_difference(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_AutoBalanceDifference(self.addr()) }
	}
	fn get_score_slomo_time(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_ScoreSlomoTime(self.addr()) }
	}
	fn get_game_time_remaining(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_GameTimeRemaining(self.addr()) }
	}
	fn get_seconds_remaining(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_SecondsRemaining(self.addr()) }
	}
	fn get_wait_time_remaining(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_WaitTimeRemaining(self.addr()) }
	}
	fn get_total_game_time_played(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_TotalGameTimePlayed(self.addr()) }
	}
	fn get_overtime_time_played(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_OvertimeTimePlayed(self.addr()) }
	}
	fn get_b_round_active(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bRoundActive(self.addr()) }
	}
	fn get_b_play_replays(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bPlayReplays(self.addr()) }
	}
	fn get_b_ball_has_been_hit(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bBallHasBeenHit(self.addr()) }
	}
	fn get_b_over_time(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bOverTime(self.addr()) }
	}
	fn get_b_unlimited_time(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bUnlimitedTime(self.addr()) }
	}
	fn get_b_no_contest(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bNoContest(self.addr()) }
	}
	fn get_b_disable_goal_delay(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bDisableGoalDelay(self.addr()) }
	}
	fn get_b_show_no_scorer_goal_message(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bShowNoScorerGoalMessage(self.addr()) }
	}
	fn get_b_match_ended(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bMatchEnded(self.addr()) }
	}
	fn get_b_show_intro_scene(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bShowIntroScene(self.addr()) }
	}
	fn get_b_club_match(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_Get_bClubMatch(self.addr()) }
	}
	fn get_next_spawn_index(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_NextSpawnIndex(self.addr()) }
	}
	fn get_replay_director_archetype(&self) -> Option<ReplayDirectorWrapper> {
		unsafe { ReplayDirectorWrapper::try_new(GameEvent_Soccar_TA_Get_ReplayDirectorArchetype(self.addr())) }
	}
	fn get_replay_director(&self) -> Option<ReplayDirectorWrapper> {
		unsafe { ReplayDirectorWrapper::try_new(GameEvent_Soccar_TA_Get_ReplayDirector(self.addr())) }
	}
	...
	fn get_total_game_balls(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_TotalGameBalls(self.addr()) }
	}
	fn get_post_goal_time(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_PostGoalTime(self.addr()) }
	}
	...
	fn get_seconds_remaining_countdown(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_SecondsRemainingCountdown(self.addr()) }
	}
	...
	fn get_game_winner(&self) -> Option<TeamWrapper> {
		unsafe { TeamWrapper::try_new(GameEvent_Soccar_TA_Get_GameWinner(self.addr())) }
	}
	fn get_match_winner(&self) -> Option<TeamWrapper> {
		unsafe { TeamWrapper::try_new(GameEvent_Soccar_TA_Get_MatchWinner(self.addr())) }
	}
	fn get_replicated_scored_on_team(&self) -> u8 {
		unsafe { GameEvent_Soccar_TA_Get_ReplicatedScoredOnTeam(self.addr()) }
	}
	fn get_replicated_server_performance_state(&self) -> u8 {
		unsafe { GameEvent_Soccar_TA_Get_ReplicatedServerPerformanceState(self.addr()) }
	}
	fn get_mvp(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(GameEvent_Soccar_TA_Get_MVP(self.addr())) }
	}
	fn get_fastest_goal_player(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(GameEvent_Soccar_TA_Get_FastestGoalPlayer(self.addr())) }
	}
	fn get_slowest_goal_player(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(GameEvent_Soccar_TA_Get_SlowestGoalPlayer(self.addr())) }
	}
	fn get_furthest_goal_player(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(GameEvent_Soccar_TA_Get_FurthestGoalPlayer(self.addr())) }
	}
	fn get_fastest_goal_speed(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_FastestGoalSpeed(self.addr()) }
	}
	fn get_slowest_goal_speed(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_SlowestGoalSpeed(self.addr()) }
	}
	fn get_furthest_goal(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_FurthestGoal(self.addr()) }
	}
	fn get_round_num(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_Get_RoundNum(self.addr()) }
	}
	fn get_assist_max_time(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_AssistMaxTime(self.addr()) }
	}
	fn get_ball_has_been_hit_start_delay(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_BallHasBeenHitStartDelay(self.addr()) }
	}
	fn get_podium_delay(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_PodiumDelay(self.addr()) }
	}
	fn get_podium_time(&self) -> f32 {
		unsafe { GameEvent_Soccar_TA_Get_PodiumTime(self.addr()) }
	}
	fn get_pauser(&self) -> Option<PlayerControllerWrapper> {
		unsafe { PlayerControllerWrapper::try_new(GameEvent_Soccar_TA_Get_Pauser(self.addr())) }
	}
	fn check_start(&self) {
		unsafe {
	...
	fn get_player_car_count(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_GetPlayerCarCount(self.addr()) }
	}
	...
	fn can_spawn_bots(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanSpawnBots(self.addr()) }
	}
	fn start_round(&self) {
		unsafe {
	...
	fn can_award_points(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanAwardPoints(self.addr()) }
	}
	...
	fn determine_score_touch_index(&self, ball: BallWrapper, goal: GoalWrapper) -> i32 {
		unsafe { GameEvent_Soccar_TA_DetermineScoreTouchIndex(self.addr(), ball.addr(), goal.addr()) }
	}
	fn determine_assist_touch_index(&self, ball: BallWrapper, score_idx: i32) -> i32 {
		unsafe { GameEvent_Soccar_TA_DetermineAssistTouchIndex(self.addr(), ball.addr(), score_idx) }
	}
	...
	fn can_update_game_time(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanUpdateGameTime(self.addr()) }
	}
	...
	fn can_enable_car_podium_movement(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanEnableCarPodiumMovement(self.addr()) }
	}
	...
	fn allow_dynamic_crowd(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_AllowDynamicCrowd(self.addr()) }
	}
	...
	fn show_scorer_goal_message(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShowScorerGoalMessage(self.addr()) }
	}
	fn can_use_ball_cam(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanUseBallCam(self.addr()) }
	}
	fn disable_stat_xp(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_DisableStatXP(self.addr()) }
	}
	...
	fn should_count_up(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldCountUp(self.addr()) }
	}
	fn should_allow_vote_to_forfeit(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldAllowVoteToForfeit(self.addr()) }
	}
	fn should_have_leave_match_penalty(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldHaveLeaveMatchPenalty(self.addr()) }
	}
	...
	fn should_countdown_resume_from_pause(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldCountdownResumeFromPause(self.addr()) }
	}
	...
	fn should_play_replay(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldPlayReplay(self.addr()) }
	}
	fn should_record_replay(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldRecordReplay(self.addr()) }
	}
	...
	fn get_total_score(&self) -> i32 {
		unsafe { GameEvent_Soccar_TA_GetTotalScore(self.addr()) }
	}
	...
	fn mvp_sort(&self, a: PriWrapper, b: PriWrapper) -> i32 {
		unsafe { GameEvent_Soccar_TA_MVPSort(self.addr(), a.addr(), b.addr()) }
	}
	...
	fn enough_time_passed_to_forfeit(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_EnoughTimePassedToForfeit(self.addr()) }
	}
	...
	fn get_winning_team(&self) -> Option<TeamWrapper> {
		unsafe { TeamWrapper::try_new(GameEvent_Soccar_TA_GetWinningTeam(self.addr())) }
	}
	...
	fn has_winner(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_HasWinner(self.addr()) }
	}
	...
	fn should_do_podium_spotlight(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_ShouldDoPodiumSpotlight(self.addr()) }
	}
	fn end_game(&self) {
		unsafe {
	...
	fn can_init_club_match(&self) -> bool {
		unsafe { GameEvent_Soccar_TA_CanInitClubMatch(self.addr()) }
	}
...
extern "C" {
	...
	fn GameEvent_Soccar_TA_SetScoreAndTime(
		obj: usize,
		PC: usize,
		NewScoreTeam0: i32,
		NewScoreTeam1: i32,
		InGameTimeRemaining: i32,
		bInOvertime: bool,
		bRestartRound: bool
	);
