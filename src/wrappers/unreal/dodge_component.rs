...
pub trait DodgeComponent: CarComponent {
	fn get_dodge_input_threshold(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeInputThreshold(self.addr()) }
	}
	fn get_side_dodge_impulse(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_SideDodgeImpulse(self.addr()) }
	}
	fn get_side_dodge_impulse_max_speed_scale(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_SideDodgeImpulseMaxSpeedScale(self.addr()) }
	}
	fn get_forward_dodge_impulse(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_ForwardDodgeImpulse(self.addr()) }
	}
	fn get_forward_dodge_impulse_max_speed_scale(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_ForwardDodgeImpulseMaxSpeedScale(self.addr()) }
	}
	fn get_backward_dodge_impulse(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_BackwardDodgeImpulse(self.addr()) }
	}
	fn get_backward_dodge_impulse_max_speed_scale(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_BackwardDodgeImpulseMaxSpeedScale(self.addr()) }
	}
	fn get_side_dodge_torque(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_SideDodgeTorque(self.addr()) }
	}
	fn get_forward_dodge_torque(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_ForwardDodgeTorque(self.addr()) }
	}
	fn get_dodge_torque_time(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeTorqueTime(self.addr()) }
	}
	fn get_min_dodge_torque_time(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_MinDodgeTorqueTime(self.addr()) }
	}
	fn get_dodge_z_damping(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeZDamping(self.addr()) }
	}
	fn get_dodge_z_damping_delay(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeZDampingDelay(self.addr()) }
	}
	fn get_dodge_z_damping_up_time(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeZDampingUpTime(self.addr()) }
	}
	fn get_dodge_impulse_scale(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeImpulseScale(self.addr()) }
	}
	fn get_dodge_torque_scale(&self) -> f32 {
		unsafe { CarComponent_Dodge_TA_Get_DodgeTorqueScale(self.addr()) }
	}
	...
	fn can_activate(&self) -> bool {
		unsafe { CarComponent_Dodge_TA_CanActivate(self.addr()) }
	}
	fn on_created(&self) {
		unsafe {
