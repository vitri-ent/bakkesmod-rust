...
pub trait HitForcePickup: RumblePickupComponent {
	fn get_b_ball_force(&self) -> bool {
		unsafe { SpecialPickup_HitForce_TA_Get_bBallForce(self.addr()) }
	}
	fn get_b_car_force(&self) -> bool {
		unsafe { SpecialPickup_HitForce_TA_Get_bCarForce(self.addr()) }
	}
	fn get_b_demolish_cars(&self) -> bool {
		unsafe { SpecialPickup_HitForce_TA_Get_bDemolishCars(self.addr()) }
	}
	fn get_ball_hit_force(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_BallHitForce(self.addr()) }
	}
	fn get_car_hit_force(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_CarHitForce(self.addr()) }
	}
	fn get_min_fx_time(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_MinFXTime(self.addr()) }
	}
	fn get_orig_ball_hit_force(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_OrigBallHitForce(self.addr()) }
	}
	fn get_orig_car_hit_force(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_OrigCarHitForce(self.addr()) }
	}
	fn get_last_fx_time(&self) -> f32 {
		unsafe { SpecialPickup_HitForce_TA_Get_LastFXTime(self.addr()) }
	}
	fn pickup_end(&self) {
		unsafe {
