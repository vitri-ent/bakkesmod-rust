...
pub trait PlayerReplicationInfo: Actor {
	fn get_score(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_Score(self.addr()) }
	}
	fn get_deaths(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_Deaths(self.addr()) }
	}
	fn get_ping(&self) -> u8 {
		unsafe { PlayerReplicationInfo_Get_Ping(self.addr()) }
	}
	fn get_tts_speaker(&self) -> u8 {
		unsafe { PlayerReplicationInfo_Get_TTSSpeaker(self.addr()) }
	}
	fn get_num_lives(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_NumLives(self.addr()) }
	}
	...
	fn get_player_id(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_PlayerID(self.addr()) }
	}
	fn get_team(&self) -> Option<TeamInfoWrapper> {
		unsafe { TeamInfoWrapper::try_new(PlayerReplicationInfo_Get_Team(self.addr())) }
	}
	fn get_b_admin(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bAdmin(self.addr()) }
	}
	fn get_b_is_spectator(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bIsSpectator(self.addr()) }
	}
	fn get_b_only_spectator(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bOnlySpectator(self.addr()) }
	}
	fn get_b_waiting_player(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bWaitingPlayer(self.addr()) }
	}
	fn get_b_ready_to_play(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bReadyToPlay(self.addr()) }
	}
	fn get_b_out_of_lives(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bOutOfLives(self.addr()) }
	}
	fn get_b_bot(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bBot(self.addr()) }
	}
	fn get_b_is_inactive(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bIsInactive(self.addr()) }
	}
	fn get_b_from_previous_level(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bFromPreviousLevel(self.addr()) }
	}
	fn get_b_timed_out(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bTimedOut(self.addr()) }
	}
	fn get_b_unregistered(&self) -> bool {
		unsafe { PlayerReplicationInfo_Get_bUnregistered(self.addr()) }
	}
	fn get_start_time(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_StartTime(self.addr()) }
	}
	...
	fn get_kills(&self) -> i32 {
		unsafe { PlayerReplicationInfo_Get_Kills(self.addr()) }
	}
	fn get_exact_ping(&self) -> f32 {
		unsafe { PlayerReplicationInfo_Get_ExactPing(self.addr()) }
	}
	...
	fn is_invalid_name(&self) -> bool {
		unsafe { PlayerReplicationInfo_IsInvalidName(self.addr()) }
	}
	fn get_team_num(&self) -> u8 {
		unsafe { PlayerReplicationInfo_GetTeamNum(self.addr()) }
	}
	...
	fn duplicate(&self) -> Option<PlayerReplicationInfoWrapper> {
		unsafe { PlayerReplicationInfoWrapper::try_new(PlayerReplicationInfo_Duplicate(self.addr())) }
	}
