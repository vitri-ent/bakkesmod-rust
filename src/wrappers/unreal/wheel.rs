...
pub trait Wheel: Object {
	fn get_steer_factor(&self) -> f32 {
		unsafe { Wheel_TA_Get_SteerFactor(self.addr()) }
	}
	fn get_wheel_radius(&self) -> f32 {
		unsafe { Wheel_TA_Get_WheelRadius(self.addr()) }
	}
	fn get_suspension_stiffness(&self) -> f32 {
		unsafe { Wheel_TA_Get_SuspensionStiffness(self.addr()) }
	}
	fn get_suspension_damping_compression(&self) -> f32 {
		unsafe { Wheel_TA_Get_SuspensionDampingCompression(self.addr()) }
	}
	fn get_suspension_damping_relaxation(&self) -> f32 {
		unsafe { Wheel_TA_Get_SuspensionDampingRelaxation(self.addr()) }
	}
	fn get_suspension_travel(&self) -> f32 {
		unsafe { Wheel_TA_Get_SuspensionTravel(self.addr()) }
	}
	fn get_suspension_max_raise(&self) -> f32 {
		unsafe { Wheel_TA_Get_SuspensionMaxRaise(self.addr()) }
	}
	fn get_contact_force_distance(&self) -> f32 {
		unsafe { Wheel_TA_Get_ContactForceDistance(self.addr()) }
	}
	fn get_spin_speed_decay_rate(&self) -> f32 {
		unsafe { Wheel_TA_Get_SpinSpeedDecayRate(self.addr()) }
	}
	...
	fn get_vehicle_sim(&self) -> Option<VehicleSimWrapper> {
		unsafe { VehicleSimWrapper::try_new(Wheel_TA_Get_VehicleSim(self.addr())) }
	}
	fn get_wheel_index(&self) -> i32 {
		unsafe { Wheel_TA_Get_WheelIndex(self.addr()) }
	}
	...
	fn get_b_draw_debug(&self) -> bool {
		unsafe { Wheel_TA_Get_bDrawDebug(self.addr()) }
	}
	fn get_b_had_contact(&self) -> bool {
		unsafe { Wheel_TA_Get_bHadContact(self.addr()) }
	}
	fn get_friction_curve_input(&self) -> f32 {
		unsafe { Wheel_TA_Get_FrictionCurveInput(self.addr()) }
	}
	fn get_aerial_throttle_to_velocity_factor(&self) -> f32 {
		unsafe { Wheel_TA_Get_AerialThrottleToVelocityFactor(self.addr()) }
	}
	fn get_aerial_acceleration_factor(&self) -> f32 {
		unsafe { Wheel_TA_Get_AerialAccelerationFactor(self.addr()) }
	}
	fn get_spin_speed(&self) -> f32 {
		unsafe { Wheel_TA_Get_SpinSpeed(self.addr()) }
	}
	...
	fn get_suspension_distance(&self) -> f32 {
		unsafe { Wheel_TA_GetSuspensionDistance(self.addr()) }
	}
