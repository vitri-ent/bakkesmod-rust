...
pub trait GrapplingHookPickup: TargetedPickup {
	fn get_impulse(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_Impulse(self.addr()) }
	}
	fn get_force(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_Force(self.addr()) }
	}
	fn get_max_rope_length(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_MaxRopeLength(self.addr()) }
	}
	fn get_prediction_speed(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_PredictionSpeed(self.addr()) }
	}
	fn get_b_deactivate_on_touch(&self) -> bool {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_bDeactivateOnTouch(self.addr()) }
	}
	fn get_b_instant(&self) -> bool {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_bInstant(self.addr()) }
	}
	fn get_b_blocked(&self) -> bool {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_bBlocked(self.addr()) }
	}
	fn get_b_attached_to_ball(&self) -> bool {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_bAttachedToBall(self.addr()) }
	}
	...
	fn get_rope_mesh_initial_size(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_RopeMeshInitialSize(self.addr()) }
	}
	...
	fn get_hit_distance_offset(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_HitDistanceOffset(self.addr()) }
	}
	fn get_after_attach_duration(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_AfterAttachDuration(self.addr()) }
	}
	fn get_blocked_required_move_distance(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_BlockedRequiredMoveDistance(self.addr()) }
	}
	fn get_blocked_required_move_time(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_BlockedRequiredMoveTime(self.addr()) }
	}
	fn get_blocked_start_time(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_BlockedStartTime(self.addr()) }
	}
	...
	fn get_ball(&self) -> Option<BallWrapper> {
		unsafe { BallWrapper::try_new(SpecialPickup_GrapplingHook_TA_Get_Ball(self.addr())) }
	}
	...
	fn get_rope_to_time(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_RopeToTime(self.addr()) }
	}
	fn get_current_rope_length(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_CurrentRopeLength(self.addr()) }
	}
	fn get_attach_time(&self) -> f32 {
		unsafe { SpecialPickup_GrapplingHook_TA_Get_AttachTime(self.addr()) }
	}
