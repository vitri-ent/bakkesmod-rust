...
pub trait Vehicle: RBActor {
	fn get_vehicle_sim(&self) -> Option<VehicleSimWrapper> {
		unsafe { VehicleSimWrapper::try_new(Vehicle_TA_Get_VehicleSim(self.addr())) }
	}
	...
	fn get_b_driving(&self) -> bool {
		unsafe { Vehicle_TA_Get_bDriving(self.addr()) }
	}
	fn get_b_replicated_handbrake(&self) -> bool {
		unsafe { Vehicle_TA_Get_bReplicatedHandbrake(self.addr()) }
	}
	fn get_b_jumped(&self) -> bool {
		unsafe { Vehicle_TA_Get_bJumped(self.addr()) }
	}
	fn get_b_double_jumped(&self) -> bool {
		unsafe { Vehicle_TA_Get_bDoubleJumped(self.addr()) }
	}
	fn get_b_on_ground(&self) -> bool {
		unsafe { Vehicle_TA_Get_bOnGround(self.addr()) }
	}
	fn get_b_super_sonic(&self) -> bool {
		unsafe { Vehicle_TA_Get_bSuperSonic(self.addr()) }
	}
	fn get_b_podium_mode(&self) -> bool {
		unsafe { Vehicle_TA_Get_bPodiumMode(self.addr()) }
	}
	...
	fn get_replicated_throttle(&self) -> u8 {
		unsafe { Vehicle_TA_Get_ReplicatedThrottle(self.addr()) }
	}
	fn get_replicated_steer(&self) -> u8 {
		unsafe { Vehicle_TA_Get_ReplicatedSteer(self.addr()) }
	}
	fn get_player_controller(&self) -> Option<PlayerControllerWrapper> {
		unsafe { PlayerControllerWrapper::try_new(Vehicle_TA_Get_PlayerController(self.addr())) }
	}
	fn get_pri(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(Vehicle_TA_Get_PRI(self.addr())) }
	}
	fn get_vehicle_update_tag(&self) -> i32 {
		unsafe { Vehicle_TA_Get_VehicleUpdateTag(self.addr()) }
	}
	...
	fn get_last_ball_touch_frame(&self) -> i32 {
		unsafe { Vehicle_TA_Get_LastBallTouchFrame(self.addr()) }
	}
	fn get_last_ball_impact_frame(&self) -> i32 {
		unsafe { Vehicle_TA_Get_LastBallImpactFrame(self.addr()) }
	}
	fn get_boost_component(&self) -> Option<BoostWrapper> {
		unsafe { BoostWrapper::try_new(Vehicle_TA_Get_BoostComponent(self.addr())) }
	}
	fn get_dodge_component(&self) -> Option<DodgeComponentWrapper> {
		unsafe { DodgeComponentWrapper::try_new(Vehicle_TA_Get_DodgeComponent(self.addr())) }
	}
	fn get_air_control_component(&self) -> Option<AirControlComponentWrapper> {
		unsafe { AirControlComponentWrapper::try_new(Vehicle_TA_Get_AirControlComponent(self.addr())) }
	}
	fn get_jump_component(&self) -> Option<JumpComponentWrapper> {
		unsafe { JumpComponentWrapper::try_new(Vehicle_TA_Get_JumpComponent(self.addr())) }
	}
	fn get_double_jump_component(&self) -> Option<DoubleJumpComponentWrapper> {
		unsafe { DoubleJumpComponentWrapper::try_new(Vehicle_TA_Get_DoubleJumpComponent(self.addr())) }
	}
	fn get_time_below_supersonic_speed(&self) -> f32 {
		unsafe { Vehicle_TA_Get_TimeBelowSupersonicSpeed(self.addr()) }
	}
	...
	fn is_car_within_forward_elliptical_cone(&self, other_car: VehicleWrapper, yaw_angle_degrees: f32, pitch_angle_degrees: f32) -> bool {
		unsafe { Vehicle_TA_IsCarWithinForwardEllipticalCone(self.addr(), other_car.addr(), yaw_angle_degrees, pitch_angle_degrees) }
	}
	fn get_forward_speed(&self) -> f32 {
		unsafe { Vehicle_TA_GetForwardSpeed(self.addr()) }
	}
	fn get_time_off_ground(&self) -> f32 {
		unsafe { Vehicle_TA_GetTimeOffGround(self.addr()) }
	}
	fn get_time_on_ground(&self) -> f32 {
		unsafe { Vehicle_TA_GetTimeOnGround(self.addr()) }
	}
	...
	fn is_on_wall(&self) -> bool {
		unsafe { Vehicle_TA_IsOnWall(self.addr()) }
	}
	fn is_on_ground(&self) -> bool {
		unsafe { Vehicle_TA_IsOnGround(self.addr()) }
	}
	fn get_num_wheel_world_contacts(&self) -> i32 {
		unsafe { Vehicle_TA_GetNumWheelWorldContacts(self.addr()) }
	}
	fn get_num_wheel_contacts(&self) -> i32 {
		unsafe { Vehicle_TA_GetNumWheelContacts(self.addr()) }
	}
