...
pub trait Actor: Object {
	fn get_location(&self) -> Vector {
		...
		unsafe {
			Actor_GetLocation(self.addr(), result_ptr);
		}
		result
	}
	...
	fn get_velocity(&self) -> Vector {
		...
		let result_ptr = &mut result as *mut Vector;
		unsafe {
			Actor_GetVelocity(self.addr(), result_ptr);
		}
		result
	}
	...
	fn set_velocity(&self, new_vel: Vector) {
		...
		unsafe {
			Actor_SetVelocity(self.addr(), new_vel);
		}
	}
	...
	fn add_velocity(&self, vel: Vector) {
		...
		unsafe {
			Actor_AddVelocity(self.addr(), vel);
		}
	}
	...
	fn get_rotation(&self) -> Rotator {
		...
		unsafe {
			Actor_GetRotation(self.addr(), result_ptr);
		}
		result
	}
	...
	fn set_rotation(&self, new_rot: Rotator) {
		...
		unsafe {
			Actor_SetRotation(self.addr(), new_rot);
		}
	}
	...
	fn set_torque(&self, new_torque: Vector) {
		...
		unsafe {
			Actor_SetTorque(self.addr(), new_torque);
		}
	}
	...
	fn get_angular_velocity(&self) -> Vector {
		...
		let result_ptr = &mut result as *mut Vector;
		unsafe {
			Actor_GetAngularVelocity(self.addr(), result_ptr);
		}
		result
	}
	...
	fn set_angular_velocity(&self, new_vel: Vector, add_to_current: bool) {
		...
		let new_vel = &mut new_vel as *mut Vector;
		unsafe {
			Actor_SetAngularVelocity(self.addr(), new_vel, add_to_current);
		}
	}
	...
	fn get_draw_scale(&self) -> f32 {
		unsafe { Actor_Get_DrawScale(self.addr()) }
	}
	...
	fn get_custom_time_dilation(&self) -> f32 {
		unsafe { Actor_Get_CustomTimeDilation(self.addr()) }
	}
	fn get_physics(&self) -> u8 {
		unsafe { Actor_Get_Physics(self.addr()) }
	}
	fn get_remote_role(&self) -> u8 {
		unsafe { Actor_Get_RemoteRole(self.addr()) }
	}
	fn get_role(&self) -> u8 {
		unsafe { Actor_Get_Role(self.addr()) }
	}
	fn get_collision_type(&self) -> u8 {
		unsafe { Actor_Get_CollisionType(self.addr()) }
	}
	fn get_replicated_collision_type(&self) -> u8 {
		unsafe { Actor_Get_ReplicatedCollisionType(self.addr()) }
	}
	fn get_owner(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(Actor_Get_Owner(self.addr())) }
	}
	fn get_base(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(Actor_Get_Base(self.addr())) }
	}
	fn get_b_static(&self) -> bool {
		unsafe { Actor_Get_bStatic(self.addr()) }
	}
	fn get_b_hidden(&self) -> bool {
		unsafe { Actor_Get_bHidden(self.addr()) }
	}
	fn get_b_hidden_self(&self) -> bool {
		unsafe { Actor_Get_bHiddenSelf(self.addr()) }
	}
	fn get_b_no_delete(&self) -> bool {
		unsafe { Actor_Get_bNoDelete(self.addr()) }
	}
	fn get_b_delete_me(&self) -> bool {
		unsafe { Actor_Get_bDeleteMe(self.addr()) }
	}
	fn get_b_ticked(&self) -> bool {
		unsafe { Actor_Get_bTicked(self.addr()) }
	}
	fn get_b_only_owner_see(&self) -> bool {
		unsafe { Actor_Get_bOnlyOwnerSee(self.addr()) }
	}
	fn get_b_tick_is_disabled(&self) -> bool {
		unsafe { Actor_Get_bTickIsDisabled(self.addr()) }
	}
	fn get_b_world_geometry(&self) -> bool {
		unsafe { Actor_Get_bWorldGeometry(self.addr()) }
	}
	fn get_b_ignore_rigid_body_pawns(&self) -> bool {
		unsafe { Actor_Get_bIgnoreRigidBodyPawns(self.addr()) }
	}
	fn get_b_orient_on_slope(&self) -> bool {
		unsafe { Actor_Get_bOrientOnSlope(self.addr()) }
	}
	fn get_b_is_moving(&self) -> bool {
		unsafe { Actor_Get_bIsMoving(self.addr()) }
	}
	fn get_b_always_encroach_check(&self) -> bool {
		unsafe { Actor_Get_bAlwaysEncroachCheck(self.addr()) }
	}
	fn get_b_has_alternate_target_location(&self) -> bool {
		unsafe { Actor_Get_bHasAlternateTargetLocation(self.addr()) }
	}
	fn get_b_always_relevant(&self) -> bool {
		unsafe { Actor_Get_bAlwaysRelevant(self.addr()) }
	}
	fn get_b_replicate_instigator(&self) -> bool {
		unsafe { Actor_Get_bReplicateInstigator(self.addr()) }
	}
	fn get_b_replicate_movement(&self) -> bool {
		unsafe { Actor_Get_bReplicateMovement(self.addr()) }
	}
	fn get_b_update_simulated_position(&self) -> bool {
		unsafe { Actor_Get_bUpdateSimulatedPosition(self.addr()) }
	}
	fn get_b_demo_recording(&self) -> bool {
		unsafe { Actor_Get_bDemoRecording(self.addr()) }
	}
	fn get_b_demo_owner(&self) -> bool {
		unsafe { Actor_Get_bDemoOwner(self.addr()) }
	}
	fn get_b_force_demo_relevant(&self) -> bool {
		unsafe { Actor_Get_bForceDemoRelevant(self.addr()) }
	}
	fn get_b_net_initial_rotation(&self) -> bool {
		unsafe { Actor_Get_bNetInitialRotation(self.addr()) }
	}
	fn get_b_replicate_rigid_body_location(&self) -> bool {
		unsafe { Actor_Get_bReplicateRigidBodyLocation(self.addr()) }
	}
	fn get_b_kill_during_level_transition(&self) -> bool {
		unsafe { Actor_Get_bKillDuringLevelTransition(self.addr()) }
	}
	fn get_b_post_render_if_not_visible(&self) -> bool {
		unsafe { Actor_Get_bPostRenderIfNotVisible(self.addr()) }
	}
	fn get_b_force_net_update(&self) -> bool {
		unsafe { Actor_Get_bForceNetUpdate(self.addr()) }
	}
	fn get_b_force_packet_update(&self) -> bool {
		unsafe { Actor_Get_bForcePacketUpdate(self.addr()) }
	}
	fn get_b_pending_net_update(&self) -> bool {
		unsafe { Actor_Get_bPendingNetUpdate(self.addr()) }
	}
	fn get_b_game_relevant(&self) -> bool {
		unsafe { Actor_Get_bGameRelevant(self.addr()) }
	}
	fn get_b_movable(&self) -> bool {
		unsafe { Actor_Get_bMovable(self.addr()) }
	}
	fn get_b_can_teleport(&self) -> bool {
		unsafe { Actor_Get_bCanTeleport(self.addr()) }
	}
	fn get_b_always_tick(&self) -> bool {
		unsafe { Actor_Get_bAlwaysTick(self.addr()) }
	}
	fn get_b_blocks_navigation(&self) -> bool {
		unsafe { Actor_Get_bBlocksNavigation(self.addr()) }
	}
	fn get_block_rigid_body(&self) -> bool {
		unsafe { Actor_Get_BlockRigidBody(self.addr()) }
	}
	fn get_b_collide_when_placing(&self) -> bool {
		unsafe { Actor_Get_bCollideWhenPlacing(self.addr()) }
	}
	fn get_b_collide_actors(&self) -> bool {
		unsafe { Actor_Get_bCollideActors(self.addr()) }
	}
	fn get_b_collide_world(&self) -> bool {
		unsafe { Actor_Get_bCollideWorld(self.addr()) }
	}
	fn get_b_collide_complex(&self) -> bool {
		unsafe { Actor_Get_bCollideComplex(self.addr()) }
	}
	fn get_b_block_actors(&self) -> bool {
		unsafe { Actor_Get_bBlockActors(self.addr()) }
	}
	fn get_b_blocks_teleport(&self) -> bool {
		unsafe { Actor_Get_bBlocksTeleport(self.addr()) }
	}
	fn get_b_phys_rigid_body_out_of_world_check(&self) -> bool {
		unsafe { Actor_Get_bPhysRigidBodyOutOfWorldCheck(self.addr()) }
	}
	fn get_b_component_outside_world(&self) -> bool {
		unsafe { Actor_Get_bComponentOutsideWorld(self.addr()) }
	}
	fn get_b_rigid_body_was_awake(&self) -> bool {
		unsafe { Actor_Get_bRigidBodyWasAwake(self.addr()) }
	}
	fn get_b_call_rigid_body_wake_events(&self) -> bool {
		unsafe { Actor_Get_bCallRigidBodyWakeEvents(self.addr()) }
	}
	fn get_b_bounce(&self) -> bool {
		unsafe { Actor_Get_bBounce(self.addr()) }
	}
	fn get_b_editable(&self) -> bool {
		unsafe { Actor_Get_bEditable(self.addr()) }
	}
	fn get_b_lock_location(&self) -> bool {
		unsafe { Actor_Get_bLockLocation(self.addr()) }
	}
	fn get_net_update_time(&self) -> f32 {
		unsafe { Actor_Get_NetUpdateTime(self.addr()) }
	}
	fn get_net_update_frequency(&self) -> f32 {
		unsafe { Actor_Get_NetUpdateFrequency(self.addr()) }
	}
	fn get_net_priority(&self) -> f32 {
		unsafe { Actor_Get_NetPriority(self.addr()) }
	}
	fn get_last_net_update_time(&self) -> f32 {
		unsafe { Actor_Get_LastNetUpdateTime(self.addr()) }
	}
	fn get_last_force_packet_update_time(&self) -> f32 {
		unsafe { Actor_Get_LastForcePacketUpdateTime(self.addr()) }
	}
	fn get_time_since_last_tick(&self) -> f32 {
		unsafe { Actor_Get_TimeSinceLastTick(self.addr()) }
	}
	fn get_life_span(&self) -> f32 {
		unsafe { Actor_Get_LifeSpan(self.addr()) }
	}
	fn get_creation_time(&self) -> f32 {
		unsafe { Actor_Get_CreationTime(self.addr()) }
	}
	fn get_last_render_time(&self) -> f32 {
		unsafe { Actor_Get_LastRenderTime(self.addr()) }
	}
	fn get_hidden_editor_views(&self) -> i64 {
		unsafe { Actor_Get_HiddenEditorViews(self.addr()) }
	}
	...
	fn get_collision_component(&self) -> Option<PrimitiveComponentWrapper> {
		unsafe { PrimitiveComponentWrapper::try_new(Actor_Get_CollisionComponent(self.addr())) }
	}
	...
	fn is_in_persistent_level(&self, b_include_level_streaming_persistent: bool) -> bool {
		unsafe { Actor_IsInPersistentLevel(self.addr(), b_include_level_streaming_persistent) }
	}
	...
	fn get_team_num(&self) -> u8 {
		unsafe { Actor_GetTeamNum(self.addr()) }
	}
	fn is_player_owned(&self) -> bool {
		unsafe { Actor_IsPlayerOwned(self.addr()) }
	}
	fn is_stationary(&self) -> bool {
		unsafe { Actor_IsStationary(self.addr()) }
	}
	...
	fn get_gravity_z(&self) -> f32 {
		unsafe { Actor_GetGravityZ(self.addr()) }
	}
	fn is_overlapping(&self, a: ActorWrapper) -> bool {
		unsafe { Actor_IsOverlapping(self.addr(), a.addr()) }
	}
	...
	fn is_owned_by(&self, test_actor: ActorWrapper) -> bool {
		unsafe { Actor_IsOwnedBy(self.addr(), test_actor.addr()) }
	}
	fn is_based_on(&self, test_actor: ActorWrapper) -> bool {
		unsafe { Actor_IsBasedOn(self.addr(), test_actor.addr()) }
	}
	fn get_terminal_velocity(&self) -> f32 {
		unsafe { Actor_GetTerminalVelocity(self.addr()) }
	}
}
...
extern "C" {
	...
	fn Actor_WillOverlap(obj: usize, PosA: *mut Vector, VelA: *mut Vector, PosB: *mut Vector, VelB: *mut Vector, StepSize: f32, Radius: f32, Time: f32)
	-> bool;
