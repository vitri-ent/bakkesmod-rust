...
pub trait PlayerController: Actor {
	fn get_car(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(PlayerController_TA_Get_Car(self.addr())) }
	}
	fn get_pri(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(PlayerController_TA_Get_PRI(self.addr())) }
	}
	...
	fn get_b_received_server_shutdown_message(&self) -> bool {
		unsafe { PlayerController_TA_Get_bReceivedServerShutdownMessage(self.addr()) }
	}
	fn get_b_use_debug_inputs(&self) -> bool {
		unsafe { PlayerController_TA_Get_bUseDebugInputs(self.addr()) }
	}
	fn get_b_jump_pressed(&self) -> bool {
		unsafe { PlayerController_TA_Get_bJumpPressed(self.addr()) }
	}
	fn get_b_boost_pressed(&self) -> bool {
		unsafe { PlayerController_TA_Get_bBoostPressed(self.addr()) }
	}
	fn get_b_handbrake_pressed(&self) -> bool {
		unsafe { PlayerController_TA_Get_bHandbrakePressed(self.addr()) }
	}
	fn get_b_has_pitched_back(&self) -> bool {
		unsafe { PlayerController_TA_Get_bHasPitchedBack(self.addr()) }
	}
	fn get_b_allow_asymmetrical_mute(&self) -> bool {
		unsafe { PlayerController_TA_Get_bAllowAsymmetricalMute(self.addr()) }
	}
	fn get_b_reset_camera(&self) -> bool {
		unsafe { PlayerController_TA_Get_bResetCamera(self.addr()) }
	}
	...
	fn get_voice_filter(&self) -> u8 {
		unsafe { PlayerController_TA_Get_VoiceFilter(self.addr()) }
	}
	fn get_chat_filter(&self) -> u8 {
		unsafe { PlayerController_TA_Get_ChatFilter(self.addr()) }
	}
	fn get_follow_target(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(PlayerController_TA_Get_FollowTarget(self.addr())) }
	}
	fn get_spectator_camera_archetype(&self) -> Option<BaseCameraWrapper> {
		unsafe { BaseCameraWrapper::try_new(PlayerController_TA_Get_SpectatorCameraArchetype(self.addr())) }
	}
	fn get_editor_camera_archetype(&self) -> Option<BaseCameraWrapper> {
		unsafe { BaseCameraWrapper::try_new(PlayerController_TA_Get_EditorCameraArchetype(self.addr())) }
	}
	...
	fn get_move_actor_grab_increment(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MoveActorGrabIncrement(self.addr()) }
	}
	fn get_min_move_actor_grab_distance(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MinMoveActorGrabDistance(self.addr()) }
	}
	fn get_mouse_increment_speed(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseIncrementSpeed(self.addr()) }
	}
	fn get_ball_velocity_increment_amount(&self) -> f32 {
		unsafe { PlayerController_TA_Get_BallVelocityIncrementAmount(self.addr()) }
	}
	fn get_ball_velocity_increment_fire_count(&self) -> i32 {
		unsafe { PlayerController_TA_Get_BallVelocityIncrementFireCount(self.addr()) }
	}
	fn get_ball_velocity_increment_fire_count_max(&self) -> f32 {
		unsafe { PlayerController_TA_Get_BallVelocityIncrementFireCountMax(self.addr()) }
	}
	fn get_ball_velocity_increment_speed_default(&self) -> f32 {
		unsafe { PlayerController_TA_Get_BallVelocityIncrementSpeedDefault(self.addr()) }
	}
	fn get_ball_velocity_increment_speed_max(&self) -> f32 {
		unsafe { PlayerController_TA_Get_BallVelocityIncrementSpeedMax(self.addr()) }
	}
	fn get_crosshair_trace_distance(&self) -> f32 {
		unsafe { PlayerController_TA_Get_CrosshairTraceDistance(self.addr()) }
	}
	fn get_traced_crosshair_actor(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(PlayerController_TA_Get_TracedCrosshairActor(self.addr())) }
	}
	...
	fn get_rotate_actor_camera_side(&self) -> i32 {
		unsafe { PlayerController_TA_Get_RotateActorCameraSide(self.addr()) }
	}
	fn get_desired_camera_side(&self) -> f32 {
		unsafe { PlayerController_TA_Get_DesiredCameraSide(self.addr()) }
	}
	fn get_pawn_type_changed_time(&self) -> f32 {
		unsafe { PlayerController_TA_Get_PawnTypeChangedTime(self.addr()) }
	}
	fn get_selected_spawn_archetype(&self) -> i32 {
		unsafe { PlayerController_TA_Get_SelectedSpawnArchetype(self.addr()) }
	}
	...
	fn get_min_client_input_rate(&self) -> i32 {
		unsafe { PlayerController_TA_Get_MinClientInputRate(self.addr()) }
	}
	fn get_median_client_input_rate(&self) -> i32 {
		unsafe { PlayerController_TA_Get_MedianClientInputRate(self.addr()) }
	}
	fn get_max_client_input_rate(&self) -> i32 {
		unsafe { PlayerController_TA_Get_MaxClientInputRate(self.addr()) }
	}
	fn get_configured_client_input_rate(&self) -> i32 {
		unsafe { PlayerController_TA_Get_ConfiguredClientInputRate(self.addr()) }
	}
	fn get_time_since_last_move_packet(&self) -> f32 {
		unsafe { PlayerController_TA_Get_TimeSinceLastMovePacket(self.addr()) }
	}
	fn get_time_last_replicated_move_packet(&self) -> f32 {
		unsafe { PlayerController_TA_Get_TimeLastReplicatedMovePacket(self.addr()) }
	}
	fn get_mouse_x_dead_zone(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseXDeadZone(self.addr()) }
	}
	fn get_mouse_y_dead_zone(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseYDeadZone(self.addr()) }
	}
	fn get_mouse_x_dead_zone_air(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseXDeadZoneAir(self.addr()) }
	}
	fn get_mouse_y_dead_zone_air(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseYDeadZoneAir(self.addr()) }
	}
	...
	fn get_pending_view_pri(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(PlayerController_TA_Get_PendingViewPRI(self.addr())) }
	}
	fn get_last_input_pitch_up(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputPitchUp(self.addr()) }
	}
	fn get_last_input_pitch_down(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputPitchDown(self.addr()) }
	}
	fn get_last_input_yaw_left(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputYawLeft(self.addr()) }
	}
	fn get_last_input_yaw_right(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputYawRight(self.addr()) }
	}
	fn get_last_input_pitch(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputPitch(self.addr()) }
	}
	fn get_last_input_yaw(&self) -> f32 {
		unsafe { PlayerController_TA_Get_LastInputYaw(self.addr()) }
	}
	fn get_mouse_input_max(&self) -> f32 {
		unsafe { PlayerController_TA_Get_MouseInputMax(self.addr()) }
	}
	fn get_engine_share(&self) -> Option<EngineTAWrapper> {
		unsafe { EngineTAWrapper::try_new(PlayerController_TA_Get_EngineShare(self.addr())) }
	}
	...
	fn remove_actor(&self) -> bool {
		unsafe { PlayerController_TA_RemoveActor(self.addr()) }
	}
	...
	fn calculate_mouse_axis(&self, center: f32, current_location: f32, deadzone: f32, max_dist: f32) -> f32 {
		unsafe { PlayerController_TA_CalculateMouseAxis(self.addr(), center, current_location, deadzone, max_dist) }
	}
	...
	fn should_be_muted(&self, other: PlayerControllerWrapper) -> bool {
		unsafe { PlayerController_TA_ShouldBeMuted(self.addr(), other.addr()) }
	}
	fn is_communication_filtered(&self, filter: u8, other: PlayerControllerWrapper, b_preset: bool) -> bool {
		unsafe { PlayerController_TA_IsCommunicationFiltered(self.addr(), filter, other.addr(), b_preset) }
	}
	...
	fn can_send_message(&self, b_quick_chat_message: bool) -> bool {
		unsafe { PlayerController_TA_CanSendMessage(self.addr(), b_quick_chat_message) }
	}
	...
	fn can_chat_with(&self, other: PlayerControllerWrapper, b_preset: bool) -> bool {
		unsafe { PlayerController_TA_CanChatWith(self.addr(), other.addr(), b_preset) }
	}
	...
	fn get_game_event(&self) -> Option<GameEventWrapper> {
		unsafe { GameEventWrapper::try_new(PlayerController_TA_GetGameEvent(self.addr())) }
	}
	...
	fn get_primary_player_controller(&self) -> Option<PlayerControllerWrapper> {
		unsafe { PlayerControllerWrapper::try_new(PlayerController_TA_GetPrimaryPlayerController(self.addr())) }
	}
