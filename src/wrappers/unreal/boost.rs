...
pub trait Boost: CarComponent {
	fn get_boost_consumption_rate(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_BoostConsumptionRate(self.addr()) }
	}
	fn get_max_boost_amount(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_MaxBoostAmount(self.addr()) }
	}
	fn get_start_boost_amount(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_StartBoostAmount(self.addr()) }
	}
	fn get_current_boost_amount(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_CurrentBoostAmount(self.addr()) }
	}
	fn get_boost_modifier(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_BoostModifier(self.addr()) }
	}
	fn get_last_boost_amount_request_time(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_LastBoostAmountRequestTime(self.addr()) }
	}
	fn get_last_boost_amount(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_LastBoostAmount(self.addr()) }
	}
	fn get_b_pending_confirm_boost_amount(&self) -> bool {
		unsafe { CarComponent_Boost_TA_Get_bPendingConfirmBoostAmount(self.addr()) }
	}
	fn get_b_no_boost(&self) -> bool {
		unsafe { CarComponent_Boost_TA_Get_bNoBoost(self.addr()) }
	}
	fn get_boost_force(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_BoostForce(self.addr()) }
	}
	fn get_min_boost_time(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_MinBoostTime(self.addr()) }
	}
	fn get_recharge_rate(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_RechargeRate(self.addr()) }
	}
	fn get_recharge_delay(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_Get_RechargeDelay(self.addr()) }
	}
	fn get_unlimited_boost_ref_count(&self) -> i32 {
		unsafe { CarComponent_Boost_TA_Get_UnlimitedBoostRefCount(self.addr()) }
	}
	fn get_replicated_boost_amount(&self) -> u8 {
		unsafe { CarComponent_Boost_TA_Get_ReplicatedBoostAmount(self.addr()) }
	}
	fn should_predict_boost_consumption(&self) -> bool {
		unsafe { CarComponent_Boost_TA_ShouldPredictBoostConsumption(self.addr()) }
	}
	...
	fn get_percent_boost_full(&self) -> f32 {
		unsafe { CarComponent_Boost_TA_GetPercentBoostFull(self.addr()) }
	}
	fn is_full(&self) -> bool {
		unsafe { CarComponent_Boost_TA_IsFull(self.addr()) }
	}
	...
	fn can_deactivate(&self) -> bool {
		unsafe { CarComponent_Boost_TA_CanDeactivate(self.addr()) }
	}
	fn can_activate(&self) -> bool {
		unsafe { CarComponent_Boost_TA_CanActivate(self.addr()) }
	}
}
