...
pub trait CarComponent: Actor {
	fn get_fx_actor_archetype(&self) -> Option<FXActorWrapper> {
		unsafe { FXActorWrapper::try_new(CarComponent_TA_Get_FXActorArchetype(self.addr())) }
	}
	fn get_b_disabled(&self) -> bool {
		unsafe { CarComponent_TA_Get_bDisabled(self.addr()) }
	}
	fn get_b_auto_activate(&self) -> bool {
		unsafe { CarComponent_TA_Get_bAutoActivate(self.addr()) }
	}
	fn get_b_simulate_component(&self) -> bool {
		unsafe { CarComponent_TA_Get_bSimulateComponent(self.addr()) }
	}
	fn get_b_created(&self) -> bool {
		unsafe { CarComponent_TA_Get_bCreated(self.addr()) }
	}
	fn get_b_active(&self) -> bool {
		unsafe { CarComponent_TA_Get_bActive(self.addr()) }
	}
	fn get_b_removed_from_car(&self) -> bool {
		unsafe { CarComponent_TA_Get_bRemovedFromCar(self.addr()) }
	}
	fn get_component_data(&self) -> u8 {
		unsafe { CarComponent_TA_Get_ComponentData(self.addr()) }
	}
	fn get_replicated_active(&self) -> u8 {
		unsafe { CarComponent_TA_Get_ReplicatedActive(self.addr()) }
	}
	fn get_activator(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(CarComponent_TA_Get_Activator(self.addr())) }
	}
	fn get_vehicle(&self) -> Option<VehicleWrapper> {
		unsafe { VehicleWrapper::try_new(CarComponent_TA_Get_Vehicle(self.addr())) }
	}
	fn get_car(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(CarComponent_TA_Get_Car(self.addr())) }
	}
	fn get_activity_time(&self) -> f32 {
		unsafe { CarComponent_TA_Get_ActivityTime(self.addr()) }
	}
	fn get_replicated_activity_time(&self) -> f32 {
		unsafe { CarComponent_TA_Get_ReplicatedActivityTime(self.addr()) }
	}
	fn get_fx_actor(&self) -> Option<FXActorWrapper> {
		unsafe { FXActorWrapper::try_new(CarComponent_TA_Get_FXActor(self.addr())) }
	}
	fn get_inactive_time(&self) -> f32 {
		unsafe { CarComponent_TA_GetInactiveTime(self.addr()) }
	}
	fn get_active_time(&self) -> f32 {
		unsafe { CarComponent_TA_GetActiveTime(self.addr()) }
	}
	...
	fn can_deactivate(&self) -> bool {
		unsafe { CarComponent_TA_CanDeactivate(self.addr()) }
	}
	fn conditional_deactivate(&self) -> bool {
		unsafe { CarComponent_TA_ConditionalDeactivate(self.addr()) }
	}
	fn can_activate(&self) -> bool {
		unsafe { CarComponent_TA_CanActivate(self.addr()) }
	}
	fn conditional_activate(&self) -> bool {
		unsafe { CarComponent_TA_ConditionalActivate(self.addr()) }
	}
