...
pub trait TrainingEditor: GameEditor {
	fn get_min_round_time(&self) -> f32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_MinRoundTime(self.addr()) }
	}
	fn get_max_round_time(&self) -> f32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_MaxRoundTime(self.addr()) }
	}
	fn get_b_no_editor(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_Get_bNoEditor(self.addr()) }
	}
	fn get_b_displayed_redo_penalty_message(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_Get_bDisplayedRedoPenaltyMessage(self.addr()) }
	}
	fn get_b_unsaved_changes(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_Get_bUnsavedChanges(self.addr()) }
	}
	fn get_points_scored_this_round(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_PointsScoredThisRound(self.addr()) }
	}
	fn get_shot_attempt(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_ShotAttempt(self.addr()) }
	}
	fn get_goalie_score(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_GoalieScore(self.addr()) }
	}
	fn get_play_test_type(&self) -> u8 {
		unsafe { GameEvent_TrainingEditor_TA_Get_PlayTestType(self.addr()) }
	}
	...
	fn get_goal_mesh_blocker_archetype(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(GameEvent_TrainingEditor_TA_Get_GoalMeshBlockerArchetype(self.addr())) }
	}
	fn get_training_data(&self) -> Option<GameEditorSaveDataWrapper> {
		unsafe { GameEditorSaveDataWrapper::try_new(GameEvent_TrainingEditor_TA_Get_TrainingData(self.addr())) }
	}
	fn get_save_delay_time(&self) -> f32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_SaveDelayTime(self.addr()) }
	}
	fn get_save_cooldown(&self) -> f32 {
		unsafe { GameEvent_TrainingEditor_TA_Get_SaveCooldown(self.addr()) }
	}
	...
	fn allow_dynamic_crowd(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_AllowDynamicCrowd(self.addr()) }
	}
	...
	fn get_total_rounds(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_GetTotalRounds(self.addr()) }
	}
	fn get_difficulty(&self) -> u8 {
		unsafe { GameEvent_TrainingEditor_TA_GetDifficulty(self.addr()) }
	}
	fn get_training_type(&self) -> u8 {
		unsafe { GameEvent_TrainingEditor_TA_GetTrainingType(self.addr()) }
	}
	fn destroy_ball(&self, ball: BallWrapper) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_DestroyBall(self.addr(), ball.addr()) }
	}
	fn save(&self) {
		unsafe {
	...
	fn handle_next_game(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_HandleNextGame(self.addr()) }
	}
	fn reset_balls(&self) {
		unsafe {
	...
	fn get_score(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_GetScore(self.addr()) }
	}
	...
	fn show_scorer_goal_message(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_ShowScorerGoalMessage(self.addr()) }
	}
	...
	fn show_penalty_message(&self) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_ShowPenaltyMessage(self.addr()) }
	}
	fn get_player_team_number(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_GetPlayerTeamNumber(self.addr()) }
	}
	fn get_ball_goal_score_number(&self) -> i32 {
		unsafe { GameEvent_TrainingEditor_TA_GetBallGoalScoreNumber(self.addr()) }
	}
	...
	fn increment_round(&self, b_loop: bool) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_IncrementRound(self.addr(), b_loop) }
	}
	...
	fn spawn_ball_and_start_point_at(
		...
		unsafe {
			...
			GameEvent_TrainingEditor_TA_SpawnBallAndStartPointAt(
				...
				ball_spawn_location,
				ball_spawn_rotation,
				start_point_spawn_location,
				start_point_spawn_rotation
			);
		}
	}
	...
	fn can_play_test_round_number(&self, round_number: i32) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_CanPlayTestRoundNumber(self.addr(), round_number) }
	}
	...
	fn is_valid_round_index(&self, array_index: i32) -> bool {
		unsafe { GameEvent_TrainingEditor_TA_IsValidRoundIndex(self.addr(), array_index) }
	}
...
extern "C" {
	...
	fn GameEvent_TrainingEditor_TA_SpawnArchetypeAtAndAdjustToFloor(
		obj: usize,
		Archetype: usize,
		SpawnLocation: *mut Vector,
		SpawnRotation: *mut Rotator
	) -> usize;
	fn GameEvent_TrainingEditor_TA_SpawnBallAndStartPointAt(
		obj: usize,
		BallSpawnLocation: *mut Vector,
		BallSpawnRotation: *mut Rotator,
		StartPointSpawnLocation: *mut Vector,
		StartPointSpawnRotation: *mut Rotator
	);
