...
pub trait NetStatGraph: StatGraph {
	fn get_packets_out(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_PacketsOut(self.addr())) }
	}
	fn get_packets_in(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_PacketsIn(self.addr())) }
	}
	fn get_lost_packets_out(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_LostPacketsOut(self.addr())) }
	}
	fn get_lost_packets_in(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_LostPacketsIn(self.addr())) }
	}
	fn get_bytes_out(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_BytesOut(self.addr())) }
	}
	fn get_bytes_in(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_BytesIn(self.addr())) }
	}
	fn get_latency(&self) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(NetStatGraph_TA_Get_Latency(self.addr())) }
	}
	fn get_expected_out_packet_rate(&self) -> f32 {
		unsafe { NetStatGraph_TA_Get_ExpectedOutPacketRate(self.addr()) }
	}
	fn get_expected_in_packet_rate(&self) -> f32 {
		unsafe { NetStatGraph_TA_Get_ExpectedInPacketRate(self.addr()) }
	}
	fn get_max_bytes_rate(&self) -> f32 {
		unsafe { NetStatGraph_TA_Get_MaxBytesRate(self.addr()) }
	}
