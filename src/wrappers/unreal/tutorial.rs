...
pub trait Tutorial: Server {
	...
	fn get_car_spawn_location(&self) -> Vector {
		...
		unsafe {
			Tutorial_GetCarSpawnLocation(self.addr(), result_ptr);
		}
		result
	}
	...
	fn set_car_spawn_location(&self, v: Vector) {
		...
		unsafe {
			Tutorial_SetCarSpawnLocation(self.addr(), v);
		}
	}
	...
	fn get_car_spawn_rotation(&self) -> Rotator {
		...
		unsafe {
			Tutorial_GetCarSpawnRotation(self.addr(), result_ptr);
		}
		result
	}
	...
	fn set_car_spawn_rotation(&self, r: Rotator) {
		...
		unsafe {
			Tutorial_SetCarSpawnRotation(self.addr(), r);
		}
	}
	...
	fn get_team_num(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_TeamNum(self.addr()) }
	}
	fn get_ball_goal_num(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_BallGoalNum(self.addr()) }
	}
	fn get_b_only_score_in_ball_goal_num(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_Get_bOnlyScoreInBallGoalNum(self.addr()) }
	}
	fn get_b_redo_round(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_Get_bRedoRound(self.addr()) }
	}
	fn get_b_allow_super_boost(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_Get_bAllowSuperBoost(self.addr()) }
	}
	fn get_b_displayed_redo_penalty_message(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_Get_bDisplayedRedoPenaltyMessage(self.addr()) }
	}
	fn get_b_show_boost_meter(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_Get_bShowBoostMeter(self.addr()) }
	}
	fn get_difficulty(&self) -> u8 {
		unsafe { GameEvent_Tutorial_TA_Get_Difficulty(self.addr()) }
	}
	fn get_debug_rotation_type(&self) -> u8 {
		unsafe { GameEvent_Tutorial_TA_Get_DebugRotationType(self.addr()) }
	}
	fn get_goal_depth(&self) -> f32 {
		unsafe { GameEvent_Tutorial_TA_Get_GoalDepth(self.addr()) }
	}
	fn get_game_event_rounds(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_GameEventRounds(self.addr()) }
	}
	fn get_event_start_time(&self) -> f32 {
		unsafe { GameEvent_Tutorial_TA_Get_EventStartTime(self.addr()) }
	}
	...
	fn get_spawn_index_type_override(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_SpawnIndexTypeOverride(self.addr()) }
	}
	fn get_wave_index(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_WaveIndex(self.addr()) }
	}
	fn get_wave_spawn_count(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_WaveSpawnCount(self.addr()) }
	}
	fn get_random_spawn_index(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_RandomSpawnIndex(self.addr()) }
	}
	...
	fn get_points_scored_this_round(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_PointsScoredThisRound(self.addr()) }
	}
	fn get_ball_spawn_count(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_BallSpawnCount(self.addr()) }
	}
	fn get_ball_bounce_scale(&self) -> f32 {
		unsafe { GameEvent_Tutorial_TA_Get_BallBounceScale(self.addr()) }
	}
	fn get_current_debug_step_x(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_CurrentDebugStepX(self.addr()) }
	}
	fn get_current_debug_step_y(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_CurrentDebugStepY(self.addr()) }
	}
	fn get_current_debug_step_z(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_CurrentDebugStepZ(self.addr()) }
	}
	fn get_redo_count(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_RedoCount(self.addr()) }
	}
	fn get_redo_total(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_Get_RedoTotal(self.addr()) }
	}
	fn init_intro(&self) {
		unsafe {
	...
	fn allow_dynamic_crowd(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_AllowDynamicCrowd(self.addr()) }
	}
	...
	fn get_step_loc(&self, steps: i32, total_dist: f32, b_increment: bool, out_current_step: i32) -> f32 {
		unsafe { GameEvent_Tutorial_TA_GetStepLoc(self.addr(), steps, total_dist, b_increment, out_current_step) }
	}
	...
	fn is_primary_player(&self, car: CarWrapper) -> bool {
		unsafe { GameEvent_Tutorial_TA_IsPrimaryPlayer(self.addr(), car.addr()) }
	}
	fn can_award_points(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_CanAwardPoints(self.addr()) }
	}
	...
	fn end_tutorial(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_EndTutorial(self.addr()) }
	}
	...
	fn can_redo_round(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_CanRedoRound(self.addr()) }
	}
	...
	fn get_winning_team(&self) -> Option<TeamWrapper> {
		unsafe { TeamWrapper::try_new(GameEvent_Tutorial_TA_GetWinningTeam(self.addr())) }
	}
	...
	fn can_que_save_replay(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_CanQueSaveReplay(self.addr()) }
	}
	fn reset_balls(&self) {
		unsafe {
	...
	fn get_score(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_GetScore(self.addr()) }
	}
	fn start_round(&self) {
		unsafe {
	...
	fn get_game_event_rounds2(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_GetGameEventRounds2(self.addr()) }
	}
	fn get_total_rounds(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_GetTotalRounds(self.addr()) }
	}
	...
	fn get_training_type(&self) -> u8 {
		unsafe { GameEvent_Tutorial_TA_GetTrainingType(self.addr()) }
	}
	fn end_game(&self) {
		unsafe {
	...
	fn chance(&self, chances: i32) -> bool {
		unsafe { GameEvent_Tutorial_TA_Chance(self.addr(), chances) }
	}
	fn get_opposite_team_num(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_GetOppositeTeamNum(self.addr()) }
	}
	...
	fn is_game_event_complete(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_IsGameEventComplete(self.addr()) }
	}
	...
	fn get_game_ball(&self) -> Option<BallWrapper> {
		unsafe { BallWrapper::try_new(GameEvent_Tutorial_TA_GetGameBall(self.addr())) }
	}
	fn get_game_pawn(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(GameEvent_Tutorial_TA_GetGamePawn(self.addr())) }
	}
	...
	fn is_ball_moving_towards_goal(&self, goal: GoalWrapper, ball: BallWrapper, min_velocity_for_destroy: f32, in_goal_depth: f32) -> bool {
		unsafe { GameEvent_Tutorial_TA_IsBallMovingTowardsGoal(self.addr(), goal.addr(), ball.addr(), min_velocity_for_destroy, in_goal_depth) }
	}
	...
	fn get_shuffled_spawn_index(&self) -> i32 {
		unsafe { GameEvent_Tutorial_TA_GetShuffledSpawnIndex(self.addr()) }
	}
	...
	fn should_allow_super_boost(&self) -> bool {
		unsafe { GameEvent_Tutorial_TA_ShouldAllowSuperBoost(self.addr()) }
	}
