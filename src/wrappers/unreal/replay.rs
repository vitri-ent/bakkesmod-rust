...
pub trait Replay: Object {
	...
	fn get_engine_version(&self) -> i32 {
		unsafe { Replay_TA_Get_EngineVersion(self.addr()) }
	}
	fn get_licensee_version(&self) -> i32 {
		unsafe { Replay_TA_Get_LicenseeVersion(self.addr()) }
	}
	fn get_net_version(&self) -> i32 {
		unsafe { Replay_TA_Get_NetVersion(self.addr()) }
	}
	fn get_replay_version(&self) -> i32 {
		unsafe { Replay_TA_Get_ReplayVersion(self.addr()) }
	}
	fn get_replay_last_save_version(&self) -> i32 {
		unsafe { Replay_TA_Get_ReplayLastSaveVersion(self.addr()) }
	}
	fn get_game_version(&self) -> i32 {
		unsafe { Replay_TA_Get_GameVersion(self.addr()) }
	}
	fn get_build_id(&self) -> i32 {
		unsafe { Replay_TA_Get_BuildID(self.addr()) }
	}
	fn get_changelist(&self) -> i32 {
		unsafe { Replay_TA_Get_Changelist(self.addr()) }
	}
	...
	fn get_reserve_megabytes(&self) -> i32 {
		unsafe { Replay_TA_Get_ReserveMegabytes(self.addr()) }
	}
	fn get_record_fps(&self) -> f32 {
		unsafe { Replay_TA_Get_RecordFPS(self.addr()) }
	}
	fn get_keyframe_delay(&self) -> f32 {
		unsafe { Replay_TA_Get_KeyframeDelay(self.addr()) }
	}
	fn get_max_channels(&self) -> i32 {
		unsafe { Replay_TA_Get_MaxChannels(self.addr()) }
	}
	fn get_max_replay_size_mb(&self) -> i32 {
		unsafe { Replay_TA_Get_MaxReplaySizeMB(self.addr()) }
	}
	...
	fn get_num_frames(&self) -> i32 {
		unsafe { Replay_TA_Get_NumFrames(self.addr()) }
	}
	...
	fn get_b_file_corrupted(&self) -> bool {
		unsafe { Replay_TA_Get_bFileCorrupted(self.addr()) }
	}
	fn get_b_force_keyframe(&self) -> bool {
		unsafe { Replay_TA_Get_bForceKeyframe(self.addr()) }
	}
	fn get_b_loaded_net_packages(&self) -> bool {
		unsafe { Replay_TA_Get_bLoadedNetPackages(self.addr()) }
	}
	fn get_b_debug(&self) -> bool {
		unsafe { Replay_TA_Get_bDebug(self.addr()) }
	}
	fn get_replay_state(&self) -> u8 {
		unsafe { Replay_TA_Get_ReplayState(self.addr()) }
	}
	fn get_current_frame(&self) -> i32 {
		unsafe { Replay_TA_Get_CurrentFrame(self.addr()) }
	}
	fn get_next_keyframe(&self) -> i32 {
		unsafe { Replay_TA_Get_NextKeyframe(self.addr()) }
	}
	fn get_current_time(&self) -> f32 {
		unsafe { Replay_TA_Get_CurrentTime(self.addr()) }
	}
	fn get_accumulated_delta_time(&self) -> f32 {
		unsafe { Replay_TA_Get_AccumulatedDeltaTime(self.addr()) }
	}
	fn get_time_to_skip_to(&self) -> f32 {
		unsafe { Replay_TA_Get_TimeToSkipTo(self.addr()) }
	}
	fn get_frame_to_skip_to(&self) -> i32 {
		unsafe { Replay_TA_Get_FrameToSkipTo(self.addr()) }
	}
	fn get_players_only_ticks(&self) -> i32 {
		unsafe { Replay_TA_Get_PlayersOnlyTicks(self.addr()) }
	}
	fn get_playback_time(&self) -> f32 {
		unsafe { Replay_TA_GetPlaybackTime(self.addr()) }
	}
	fn is_from_before_game_version(&self, before_game_version: u8) -> bool {
		unsafe { Replay_TA_IsFromBeforeGameVersion(self.addr(), before_game_version) }
	}
	fn is_from_before_replay_version(&self, before_replay_version: u8) -> bool {
		unsafe { Replay_TA_IsFromBeforeReplayVersion(self.addr(), before_replay_version) }
	}
	...
	fn create_copy(&self, start_time: f32) -> Option<ReplayWrapper> {
		unsafe { ReplayWrapper::try_new(Replay_TA_CreateCopy(self.addr(), start_time)) }
	}
	...
	fn get_replay_time_seconds(&self) -> f32 {
		unsafe { Replay_TA_GetReplayTimeSeconds(self.addr()) }
	}
