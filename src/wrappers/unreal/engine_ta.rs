...
pub trait EngineTA: Object {
	fn get_b_enable_client_prediction(&self) -> bool {
		unsafe { EngineShare_TA_Get_bEnableClientPrediction(self.addr()) }
	}
	fn get_b_client_physics_update(&self) -> bool {
		unsafe { EngineShare_TA_Get_bClientPhysicsUpdate(self.addr()) }
	}
	fn get_b_disable_client_corrections(&self) -> bool {
		unsafe { EngineShare_TA_Get_bDisableClientCorrections(self.addr()) }
	}
	fn get_b_debug_client_corrections(&self) -> bool {
		unsafe { EngineShare_TA_Get_bDebugClientCorrections(self.addr()) }
	}
	fn get_b_force_client_correction(&self) -> bool {
		unsafe { EngineShare_TA_Get_bForceClientCorrection(self.addr()) }
	}
	fn get_physics_framerate(&self) -> f32 {
		unsafe { EngineShare_TA_Get_PhysicsFramerate(self.addr()) }
	}
	fn get_max_physics_substeps(&self) -> i32 {
		unsafe { EngineShare_TA_Get_MaxPhysicsSubsteps(self.addr()) }
	}
	fn get_max_uploaded_client_frames(&self) -> i32 {
		unsafe { EngineShare_TA_Get_MaxUploadedClientFrames(self.addr()) }
	}
	fn get_max_client_replay_frames(&self) -> i32 {
		unsafe { EngineShare_TA_Get_MaxClientReplayFrames(self.addr()) }
	}
	fn get_physics_frame(&self) -> i32 {
		unsafe { EngineShare_TA_Get_PhysicsFrame(self.addr()) }
	}
	fn get_render_alpha(&self) -> f32 {
		unsafe { EngineShare_TA_Get_RenderAlpha(self.addr()) }
	}
	fn get_replicated_physics_frame(&self) -> i32 {
		unsafe { EngineShare_TA_Get_ReplicatedPhysicsFrame(self.addr()) }
	}
	fn get_dirty_physics_frame(&self) -> i32 {
		unsafe { EngineShare_TA_Get_DirtyPhysicsFrame(self.addr()) }
	}
	fn get_force_correction_frames(&self) -> i32 {
		unsafe { EngineShare_TA_Get_ForceCorrectionFrames(self.addr()) }
	}
	fn get_tick_notify_index(&self) -> i32 {
		unsafe { EngineShare_TA_Get_TickNotifyIndex(self.addr()) }
	}
	...
	fn get_last_bug_report_time(&self) -> f32 {
		unsafe { EngineShare_TA_Get_LastBugReportTime(self.addr()) }
	}
	fn get_debug_client_correction_start_time(&self) -> f32 {
		unsafe { EngineShare_TA_Get_DebugClientCorrectionStartTime(self.addr()) }
	}
	fn get_debug_client_correction_count(&self) -> i32 {
		unsafe { EngineShare_TA_Get_DebugClientCorrectionCount(self.addr()) }
	}
	fn get_stat_graphs(&self) -> Option<StatGraphSystemWrapper> {
		unsafe { StatGraphSystemWrapper::try_new(EngineShare_TA_Get_StatGraphs(self.addr())) }
	}
	fn get_last_physics_delta_time_scale(&self) -> f32 {
		unsafe { EngineShare_TA_Get_LastPhysicsDeltaTimeScale(self.addr()) }
	}
	...
	fn get_bullet_fixed_delta_time(&self) -> f32 {
		unsafe { EngineShare_TA_GetBulletFixedDeltaTime(self.addr()) }
	}
	...
	fn get_physics_time(&self) -> f32 {
		unsafe { EngineShare_TA_GetPhysicsTime(self.addr()) }
	}
