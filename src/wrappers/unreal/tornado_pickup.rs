...
pub trait TornadoPickup: RumblePickupComponent {
	fn get_height(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_Height(self.addr()) }
	}
	fn get_radius(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_Radius(self.addr()) }
	}
	...
	fn get_rotational_force(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_RotationalForce(self.addr()) }
	}
	fn get_torque(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_Torque(self.addr()) }
	}
	...
	fn get_max_velocity_offset(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_MaxVelocityOffset(self.addr()) }
	}
	fn get_ball_multiplier(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_BallMultiplier(self.addr()) }
	}
	fn get_b_debug_vis(&self) -> bool {
		unsafe { SpecialPickup_Tornado_TA_Get_bDebugVis(self.addr()) }
	}
	fn get_velocity_ease(&self) -> f32 {
		unsafe { SpecialPickup_Tornado_TA_Get_VelocityEase(self.addr()) }
	}
