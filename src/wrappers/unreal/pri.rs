...
pub trait Pri: PriX {
	fn get_match_score(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchScore(self.addr()) }
	}
	fn get_match_goals(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchGoals(self.addr()) }
	}
	fn get_match_own_goals(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchOwnGoals(self.addr()) }
	}
	fn get_match_assists(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchAssists(self.addr()) }
	}
	fn get_match_saves(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchSaves(self.addr()) }
	}
	fn get_match_shots(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchShots(self.addr()) }
	}
	fn get_match_demolishes(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchDemolishes(self.addr()) }
	}
	fn get_match_bonus_xp(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchBonusXP(self.addr()) }
	}
	fn get_match_breakout_damage(&self) -> i32 {
		unsafe { PRI_TA_Get_MatchBreakoutDamage(self.addr()) }
	}
	fn get_b_match_mvp(&self) -> bool {
		unsafe { PRI_TA_Get_bMatchMVP(self.addr()) }
	}
	fn get_b_match_admin(&self) -> bool {
		unsafe { PRI_TA_Get_bMatchAdmin(self.addr()) }
	}
	fn get_b_loadout_set(&self) -> bool {
		unsafe { PRI_TA_Get_bLoadoutSet(self.addr()) }
	}
	fn get_b_online_loadout_set(&self) -> bool {
		unsafe { PRI_TA_Get_bOnlineLoadoutSet(self.addr()) }
	}
	fn get_b_loadouts_set(&self) -> bool {
		unsafe { PRI_TA_Get_bLoadoutsSet(self.addr()) }
	}
	fn get_b_online_loadouts_set(&self) -> bool {
		unsafe { PRI_TA_Get_bOnlineLoadoutsSet(self.addr()) }
	}
	fn get_b_team_paint_set(&self) -> bool {
		unsafe { PRI_TA_Get_bTeamPaintSet(self.addr()) }
	}
	fn get_b_ready(&self) -> bool {
		unsafe { PRI_TA_Get_bReady(self.addr()) }
	}
	fn get_b_using_secondary_camera(&self) -> bool {
		unsafe { PRI_TA_Get_bUsingSecondaryCamera(self.addr()) }
	}
	fn get_b_using_behind_view(&self) -> bool {
		unsafe { PRI_TA_Get_bUsingBehindView(self.addr()) }
	}
	fn get_b_using_freecam(&self) -> bool {
		unsafe { PRI_TA_Get_bUsingFreecam(self.addr()) }
	}
	fn get_b_is_in_split_screen(&self) -> bool {
		unsafe { PRI_TA_Get_bIsInSplitScreen(self.addr()) }
	}
	fn get_b_start_vote_to_forfeit_disabled(&self) -> bool {
		unsafe { PRI_TA_Get_bStartVoteToForfeitDisabled(self.addr()) }
	}
	fn get_b_using_items(&self) -> bool {
		unsafe { PRI_TA_Get_bUsingItems(self.addr()) }
	}
	fn get_player_history_valid(&self) -> bool {
		unsafe { PRI_TA_Get_PlayerHistoryValid(self.addr()) }
	}
	fn get_game_event(&self) -> Option<GameEventWrapper> {
		unsafe { GameEventWrapper::try_new(PRI_TA_Get_GameEvent(self.addr())) }
	}
	fn get_replicated_game_event(&self) -> Option<GameEventWrapper> {
		unsafe { GameEventWrapper::try_new(PRI_TA_Get_ReplicatedGameEvent(self.addr())) }
	}
	fn get_car(&self) -> Option<CarWrapper> {
		unsafe { CarWrapper::try_new(PRI_TA_Get_Car(self.addr())) }
	}
	fn get_waiting_start_time(&self) -> i32 {
		unsafe { PRI_TA_Get_WaitingStartTime(self.addr()) }
	}
	fn get_total_game_time_played(&self) -> f32 {
		unsafe { PRI_TA_Get_TotalGameTimePlayed(self.addr()) }
	}
	...
	fn get_camera_pitch(&self) -> u8 {
		unsafe { PRI_TA_Get_CameraPitch(self.addr()) }
	}
	fn get_camera_yaw(&self) -> u8 {
		unsafe { PRI_TA_Get_CameraYaw(self.addr()) }
	}
	fn get_pawn_type(&self) -> u8 {
		unsafe { PRI_TA_Get_PawnType(self.addr()) }
	}
	fn get_replicated_worst_net_quality_beyond_latency(&self) -> u8 {
		unsafe { PRI_TA_Get_ReplicatedWorstNetQualityBeyondLatency(self.addr()) }
	}
	...
	fn get_dodge_input_threshold(&self) -> f32 {
		unsafe { PRI_TA_Get_DodgeInputThreshold(self.addr()) }
	}
	fn get_steering_sensitivity(&self) -> f32 {
		unsafe { PRI_TA_Get_SteeringSensitivity(self.addr()) }
	}
	fn get_air_control_sensitivity(&self) -> f32 {
		unsafe { PRI_TA_Get_AirControlSensitivity(self.addr()) }
	}
	fn get_time_till_item(&self) -> i32 {
		unsafe { PRI_TA_Get_TimeTillItem(self.addr()) }
	}
	fn get_max_time_till_item(&self) -> i32 {
		unsafe { PRI_TA_Get_MaxTimeTillItem(self.addr()) }
	}
	fn get_boost_pickups(&self) -> i32 {
		unsafe { PRI_TA_Get_BoostPickups(self.addr()) }
	}
	fn get_ball_touches(&self) -> i32 {
		unsafe { PRI_TA_Get_BallTouches(self.addr()) }
	}
	fn get_car_touches(&self) -> i32 {
		unsafe { PRI_TA_Get_CarTouches(self.addr()) }
	}
	fn get_replacing_bot_pri(&self) -> Option<PriWrapper> {
		unsafe { PriWrapper::try_new(PRI_TA_Get_ReplacingBotPRI(self.addr())) }
	}
	fn get_club_id(&self) -> i64 {
		unsafe { PRI_TA_Get_ClubID(self.addr()) }
	}
	...
	fn get_spectator_shortcut(&self) -> i32 {
		unsafe { PRI_TA_Get_SpectatorShortcut(self.addr()) }
	}
	...
	fn validate_loadout_team_paints(&self) -> bool {
		unsafe { PRI_TA_ValidateLoadoutTeamPaints(self.addr()) }
	}
	fn validate_loadout_slots(&self) -> bool {
		unsafe { PRI_TA_ValidateLoadoutSlots(self.addr()) }
	}
	...
	fn is_player(&self) -> bool {
		unsafe { PRI_TA_IsPlayer(self.addr()) }
	}
	fn is_editor(&self) -> bool {
		unsafe { PRI_TA_IsEditor(self.addr()) }
	}
	fn is_spectator(&self) -> bool {
		unsafe { PRI_TA_IsSpectator(self.addr()) }
	}
	...
	fn is_invalid_name(&self) -> bool {
		unsafe { PRI_TA_IsInvalidName(self.addr()) }
	}
	fn is_in_warm_up_mode(&self) -> bool {
		unsafe { PRI_TA_IsInWarmUpMode(self.addr()) }
	}
	...
	fn should_broad_cast_welcome_message(&self, b_exiting: bool) -> bool {
		unsafe { PRI_TA_ShouldBroadCastWelcomeMessage(self.addr(), b_exiting) }
	}
	...
	fn get_match_xp(&self) -> i32 {
		unsafe { PRI_TA_GetMatchXP(self.addr()) }
	}
	...
	fn is_client_player_pri(&self) -> bool {
		unsafe { PRI_TA_IsClientPlayerPRI(self.addr()) }
	}
	fn is_local_player_pri(&self) -> bool {
		unsafe { PRI_TA_IsLocalPlayerPRI(self.addr()) }
	}
	fn unregister(&self) {
		unsafe {
	...
	fn are_loadouts_set(&self) -> bool {
		unsafe { PRI_TA_AreLoadoutsSet(self.addr()) }
	}
	...
	fn should_validate_online_products(&self) -> bool {
		unsafe { PRI_TA_ShouldValidateOnlineProducts(self.addr()) }
	}
