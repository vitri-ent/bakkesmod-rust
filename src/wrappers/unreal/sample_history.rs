...
pub trait SampleHistory: Object {
	fn get_record_settings(&self) -> Option<SampleRecordSettingsWrapper> {
		unsafe { SampleRecordSettingsWrapper::try_new(SampleHistory_TA_Get_RecordSettings(self.addr())) }
	}
	...
	fn get_y_min(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_YMin(self.addr()) }
	}
	fn get_y_max(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_YMax(self.addr()) }
	}
	fn get_good_value(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_GoodValue(self.addr()) }
	}
	fn get_bad_value(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_BadValue(self.addr()) }
	}
	fn get_base_value(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_BaseValue(self.addr()) }
	}
	...
	fn get_sample_index(&self) -> i32 {
		unsafe { SampleHistory_TA_Get_SampleIndex(self.addr()) }
	}
	fn get_accum_time(&self) -> f32 {
		unsafe { SampleHistory_TA_Get_AccumTime(self.addr()) }
	}
	...
	fn get_b_has_pending_sample(&self) -> bool {
		unsafe { SampleHistory_TA_Get_bHasPendingSample(self.addr()) }
	}
	...
	fn get_summary_value(&self, type_: u8, max_sample_age: f32, b_absolute_value: bool) -> f32 {
		unsafe { SampleHistory_TA_GetSummaryValue(self.addr(), type_, max_sample_age, b_absolute_value) }
	}
	fn set_base_value2(&self, in_base_value: f32) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(SampleHistory_TA_SetBaseValue2(self.addr(), in_base_value)) }
	}
	fn set_good_bad_values(&self, in_good_value: f32, in_bad_value: f32) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(SampleHistory_TA_SetGoodBadValues(self.addr(), in_good_value, in_bad_value)) }
	}
	fn set_graph_max_min(&self, max_value: f32, min_value: f32) -> Option<SampleHistoryWrapper> {
		unsafe { SampleHistoryWrapper::try_new(SampleHistory_TA_SetGraphMaxMin(self.addr(), max_value, min_value)) }
	}
