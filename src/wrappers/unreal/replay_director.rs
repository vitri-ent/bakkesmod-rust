...
pub trait ReplayDirector: Actor {
	fn get_slomo_pre_score_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_SlomoPreScoreTime(self.addr()) }
	}
	fn get_slomo_post_score_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_SlomoPostScoreTime(self.addr()) }
	}
	fn get_slomo_defend_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_SlomoDefendTime(self.addr()) }
	}
	fn get_slomo_defend_distance(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_SlomoDefendDistance(self.addr()) }
	}
	fn get_slomo_time_dilation(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_SlomoTimeDilation(self.addr()) }
	}
	fn get_min_replay_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_MinReplayTime(self.addr()) }
	}
	fn get_max_replay_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_MaxReplayTime(self.addr()) }
	}
	fn get_replay_padding(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_ReplayPadding(self.addr()) }
	}
	fn get_highlight_replay_duration(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_HighlightReplayDuration(self.addr()) }
	}
	fn get_time_before_highlight_replay(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_TimeBeforeHighlightReplay(self.addr()) }
	}
	fn get_replay(&self) -> Option<ReplaySoccarWrapper> {
		unsafe { ReplaySoccarWrapper::try_new(ReplayDirector_TA_Get_Replay(self.addr())) }
	}
	fn get_focus_car(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(ReplayDirector_TA_Get_FocusCar(self.addr())) }
	}
	fn get_focus_car_change_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_FocusCarChangeTime(self.addr()) }
	}
	fn get_focus_ball(&self) -> Option<ActorWrapper> {
		unsafe { ActorWrapper::try_new(ReplayDirector_TA_Get_FocusBall(self.addr())) }
	}
	fn get_score_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_ScoreTime(self.addr()) }
	}
	fn get_score_hit_index(&self) -> i32 {
		unsafe { ReplayDirector_TA_Get_ScoreHitIndex(self.addr()) }
	}
	fn get_scored_goal(&self) -> Option<GoalWrapper> {
		unsafe { GoalWrapper::try_new(ReplayDirector_TA_Get_ScoredGoal(self.addr())) }
	}
	fn get_b_slomo(&self) -> bool {
		unsafe { ReplayDirector_TA_Get_bSlomo(self.addr()) }
	}
	fn get_b_slomo_for_defender(&self) -> bool {
		unsafe { ReplayDirector_TA_Get_bSlomoForDefender(self.addr()) }
	}
	fn get_b_auto_save(&self) -> bool {
		unsafe { ReplayDirector_TA_Get_bAutoSave(self.addr()) }
	}
	fn get_focus_hit_index(&self) -> i32 {
		unsafe { ReplayDirector_TA_Get_FocusHitIndex(self.addr()) }
	}
	fn get_focus_car_idx(&self) -> i32 {
		unsafe { ReplayDirector_TA_Get_FocusCarIdx(self.addr()) }
	}
	fn get_replay_start_game_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_ReplayStartGameTime(self.addr()) }
	}
	fn get_ball_spawn_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_Get_BallSpawnTime(self.addr()) }
	}
	fn get_soccar_game(&self) -> Option<ServerWrapper> {
		unsafe { ServerWrapper::try_new(ReplayDirector_TA_Get_SoccarGame(self.addr())) }
	}
	fn get_scored_on_team(&self) -> u8 {
		unsafe { ReplayDirector_TA_Get_ScoredOnTeam(self.addr()) }
	}
	fn get_force_cut_to_focus_actors(&self) -> i32 {
		unsafe { ReplayDirector_TA_Get_ForceCutToFocusActors(self.addr()) }
	}
	...
	fn should_slomo(&self) -> bool {
		unsafe { ReplayDirector_TA_ShouldSlomo(self.addr()) }
	}
	...
	fn get_next_highlight_frame(&self) -> i32 {
		unsafe { ReplayDirector_TA_GetNextHighlightFrame(self.addr()) }
	}
	...
	fn get_replay_time_seconds(&self) -> f32 {
		unsafe { ReplayDirector_TA_GetReplayTimeSeconds(self.addr()) }
	}
	...
	fn get_replay_start_time(&self) -> f32 {
		unsafe { ReplayDirector_TA_GetReplayStartTime(self.addr()) }
	}
