...
pub trait BaseCamera: Actor {
	fn get_default_fov(&self) -> f32 {
		unsafe { Camera_Get_DefaultFOV(self.addr()) }
	}
	fn get_b_locked_fov(&self) -> bool {
		unsafe { Camera_Get_bLockedFOV(self.addr()) }
	}
	fn get_b_constrain_aspect_ratio(&self) -> bool {
		unsafe { Camera_Get_bConstrainAspectRatio(self.addr()) }
	}
	fn get_b_enable_fading(&self) -> bool {
		unsafe { Camera_Get_bEnableFading(self.addr()) }
	}
	fn get_b_fade_audio(&self) -> bool {
		unsafe { Camera_Get_bFadeAudio(self.addr()) }
	}
	fn get_b_force_disable_temporal_aa(&self) -> bool {
		unsafe { Camera_Get_bForceDisableTemporalAA(self.addr()) }
	}
	fn get_b_enable_color_scaling(&self) -> bool {
		unsafe { Camera_Get_bEnableColorScaling(self.addr()) }
	}
	fn get_b_enable_color_scale_interp(&self) -> bool {
		unsafe { Camera_Get_bEnableColorScaleInterp(self.addr()) }
	}
	fn get_b_use_client_side_camera_updates(&self) -> bool {
		unsafe { Camera_Get_bUseClientSideCameraUpdates(self.addr()) }
	}
	fn get_b_debug_client_side_camera(&self) -> bool {
		unsafe { Camera_Get_bDebugClientSideCamera(self.addr()) }
	}
	fn get_b_should_send_client_side_camera_update(&self) -> bool {
		unsafe { Camera_Get_bShouldSendClientSideCameraUpdate(self.addr()) }
	}
	fn get_locked_fov(&self) -> f32 {
		unsafe { Camera_Get_LockedFOV(self.addr()) }
	}
	fn get_constrained_aspect_ratio(&self) -> f32 {
		unsafe { Camera_Get_ConstrainedAspectRatio(self.addr()) }
	}
	fn get_default_aspect_ratio(&self) -> f32 {
		unsafe { Camera_Get_DefaultAspectRatio(self.addr()) }
	}
	fn get_off_axis_yaw_angle(&self) -> f32 {
		unsafe { Camera_Get_OffAxisYawAngle(self.addr()) }
	}
	fn get_off_axis_pitch_angle(&self) -> f32 {
		unsafe { Camera_Get_OffAxisPitchAngle(self.addr()) }
	}
	...
	fn get_fade_amount(&self) -> f32 {
		unsafe { Camera_Get_FadeAmount(self.addr()) }
	}
	fn get_cam_override_post_process_alpha(&self) -> f32 {
		unsafe { Camera_Get_CamOverridePostProcessAlpha(self.addr()) }
	}
	...
	fn get_color_scale_interp_duration(&self) -> f32 {
		unsafe { Camera_Get_ColorScaleInterpDuration(self.addr()) }
	}
	fn get_color_scale_interp_start_time(&self) -> f32 {
		unsafe { Camera_Get_ColorScaleInterpStartTime(self.addr()) }
	}
	...
	fn get_blend_time_to_go(&self) -> f32 {
		unsafe { Camera_Get_BlendTimeToGo(self.addr()) }
	}
	fn get_free_cam_distance(&self) -> f32 {
		unsafe { Camera_Get_FreeCamDistance(self.addr()) }
	}
	...
	fn get_fade_time(&self) -> f32 {
		unsafe { Camera_Get_FadeTime(self.addr()) }
	}
	fn get_fade_time_remaining(&self) -> f32 {
		unsafe { Camera_Get_FadeTimeRemaining(self.addr()) }
	}
	...
	fn get_fov_angle(&self) -> f32 {
		unsafe { Camera_GetFOVAngle(self.addr()) }
	}
